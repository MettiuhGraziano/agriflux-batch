...
DROP TABLE IF EXISTS DATI_RANGE_STAGIONE;
...
--Tabella dati range stagione
CREATE TABLE DATI_RANGE_STAGIONE (
	ID_RANGE_STAGIONE BIGINT NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE DATI_ORTAGGIO (
	...
	ID_FAMIGLIA BIGINT,
	ID_RANGE_STAGIONE BIGINT,
	FOREIGN KEY (ID_FAMIGLIA) REFERENCES DATI_FAMIGLIA(ID_FAMIGLIA),
	FOREIGN KEY (ID_RANGE_STAGIONE) REFERENCES DATI_RANGE_STAGIONE(ID_RANGE_STAGIONE)
);
...
CREATE TABLE DATI_FATTURATO (
	...
	FOREIGN KEY (ID_AZIENDA) REFERENCES DATI_AZIENDA(ID_AZIENDA)
);
